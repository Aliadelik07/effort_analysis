...
if expInfo['task'] == "n-back":
    ...
    if expInfo['version'] == "train":
        ...
        m_correct = [5,5,5,10,10,10,15,15,15,5,10,5,5,15,15,15,10,15,15,10,10,10]
    ...
    if expInfo['version'] == "train":
        ...
        m_correct = [5,5,5,5,5,5,5,5]
        n_back = [1,2,3,3,3,3,3,3]
    else:
        #test letters
